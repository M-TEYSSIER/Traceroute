...
#				
				...
				then
					...
					echo -n " -- "'"' "Inconnue de saut $ttl & adresse final $IpCible" '"'" -- " >> $NomFichier
					break
				elif [ "$Hop" == "*" ] && [ "$proto" == "-I" ] && [ "$HopPlusUn" != "*" ]
				then
					echo -n " Inconnue " >> $NomFichier
					echo -n " -- "'"' "Réseau avant $HopPlusUn & saut $ttl & adresse final $IpClible" '"'" -- " >> $NomFichier
					break
				elif [ "$Hop" != "*" ] && [ "$Hop" != "$IpCible" ]
				then
					echo -n  '"'" $Hop "'"'  >> $NomFichier
					echo -n " -- "'"' "Réseau avant $HopPlusUn & saut $ttl & adresse final $IpCible" '"'" -- " >> $NomFichier
					break
				fi
			done
	done
